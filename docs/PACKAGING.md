...
subagents as TOML in `.codex/agents/`, the methodology map as `AGENTS.md`, `board.py` and `mismagent.py` inside
the skills that call them. Regenerated by `tools/generate-codex.py`.
