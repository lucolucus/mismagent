...
(one worktree per block); standalone, give it the block's pack (`python3 "@@MISMAGENT_SKILLS@@/mismagent-worker-composer/scripts/mismagent.py" pack F <id>`), the **working dir** + the
...
`F/decisions.md` (format: `@@MISMAGENT_SKILLS@@/mismagent-worker-composer/references/CLI.md`). See
